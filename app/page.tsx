...
function InboxSpace({ search, setModal, notify, onCall }: { search:string; setModal:(type:"message")=>void; notify:(text:string)=>void; onCall:(contact:string,video:boolean)=>void }) {
