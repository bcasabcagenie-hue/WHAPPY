...
const commands: Command[] = [
  ...
  { id: "twin", icon: "✦", title: "Mon Jumeau numérique", hint: "Voix, mouvements et automatisations", keywords: "double ia voix mouvement automatiser clone" },
