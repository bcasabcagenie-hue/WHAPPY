...
const WHAPPY_ADMIN_APK = { version: "2.1.53 native", size: "Universel", minimum: "Android 8.0+", url: "https://whappy-d97e7.web.app/WAPI-Android-2.1.53-native.apk" } as const;
