...
const WHAPPY_ADMIN_APK = { version: "1.9.5 native", size: "Universel", minimum: "Android 8.0+", url: "https://raw.githubusercontent.com/bcasabcagenie-hue/WHAPPY/codex/sites-deploy-lite/public/downloads/WAPI-Android-1.9.5-native.apk" } as const;
