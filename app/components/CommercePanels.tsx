...
export function ProductPanel({ item, saved, onSave, onClose, onContact, onAdd }: { item:CommerceItem;saved:boolean;onSave:()=>void;onClose:()=>void;onContact:(item:CommerceItem)=>void;onAdd:(quantity:number)=>void }) {
