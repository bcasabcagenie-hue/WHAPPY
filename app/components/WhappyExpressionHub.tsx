...
const symbols = "✓ ✔ ✦ ✧ ★ ☆ ◆ ◇ ● ○ ◉ ◎ ⌁ ≋ ∞ → ← ↑ ↓ ↗ ↘ ⇄ + − × ÷ = ≠ ≤ ≥ @ # % & © ® ™ € $ £ ¥ ₣ ♫ ♪ ☀ ☾ ♡ ♥ ⚡ ☎ ⌘ ⌖".split(" ");
const whappies = [
  { face: "😎", name: "Boss", line: "On passe au niveau supérieur !", colors: ["#16d629", "#064f18"] },
  ...
  { face: "🚀", name: "Fusée", line: "Direction le sommet", colors: ["#0dd6bb", "#075173"] },
];
...
async function memeFile(file: File, caption: string, effect: MediaEffect, symbol: string) {
  ...
  context.strokeStyle = "#071c0d"; context.lineWidth = 18; context.fillStyle = "#fff"; context.textAlign = "center"; context.font = "900 76px Arial";
  ...
  context.font = "110px system-ui"; context.textAlign = "right"; context.fillText(symbol, 1010, 145); context.textAlign = "left"; context.font = "900 25px Arial"; context.fillStyle = "#55ff69"; context.fillText("WHAPPY MEME LAB", 44, 62);
