...
private class WapiPool3DPlatformView(
    ...
    private fun render(next: PoolRenderState) {
        ...
        table.setPoolScene(
            ...
            moving = next.moving,
            aiAiming = next.aiAiming,
            showAim = next.showAim,
    ...
    private fun parseState(raw: Map<*, *>?, previous: PoolRenderState): PoolRenderState {
        ...
        return PoolRenderState(
            ...
            aiAiming = data["aiAiming"] as? Boolean ?: previous.aiAiming,
            showAim = data["showAim"] as? Boolean ?: previous.showAim,
