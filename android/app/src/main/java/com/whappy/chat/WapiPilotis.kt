...
object WapiPilotis {
    ...
    fun response(
        ...
        val text = when (intent) {
            ...
            WapiPilotisIntent.GROUPS -> "Je peux vous aider à organiser un groupe : administrateurs, annonces, sondages, événements, fichiers, appels collectifs et règles de modération."
