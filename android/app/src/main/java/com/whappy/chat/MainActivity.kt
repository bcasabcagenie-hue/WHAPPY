        ...
        setContent {
            ...
            CompositionLocalProvider(LocalWhappyCalls provides callController) {
                WhappyTheme {
                    ...
                    onConsumeLiveLink = model::consumeLiveLink,
                    onConsumeGroupCallLink = model::consumeGroupCallLink,
